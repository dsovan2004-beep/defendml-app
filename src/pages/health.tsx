      ...
      <div className="flex-1 bg-gradient-to-br from-slate-950 via-cyan-950 to-slate-950">
        <div className="border-b border-white/10 bg-black/20 backdrop-blur-xl">
          <div className="max-w-7xl mx-auto px-8 py-6">
            ...
            <p className="text-[#F5F5F5]">Real-time performance monitoring across all LLM providers</p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-gradient-to-br from-cyan-500/10 to-orange-600/10 rounded-xl p-6 border border-cyan-500/20">
            ...
            <div className="bg-gradient-to-br from-red-500/10 to-pink-600/10 rounded-xl p-6 border border-red-500/20">
              ...
              <div className="text-red-300 font-medium">Requests Today</div>
              <div className="text-red-400/60 text-sm mt-1">Across 5 providers</div>
            </div>
          </div>

          {/* NEW: ASL-3 Security Performance */}
          <div className="bg-gradient-to-br from-red-500/10 to-orange-600/10 rounded-xl p-6 border border-red-500/20 backdrop-blur-lg mb-8">
            <div className="flex items-center gap-3 mb-6">
              <Shield className="w-8 h-8 text-red-400" />
              <div>
                <h2 className="text-2xl font-bold text-white">ASL-3 Security Performance</h2>
                <p className="text-[#A0A0A0] text-sm">Real-time constitutional classifier and defense layer health</p>
              </div>
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="bg-white/5 backdrop-blur-lg rounded-lg p-4 border border-white/10">
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                  ...
                  <div>
                    <div className="text-xs text-[#A0A0A0] mb-1">Accuracy</div>
                    <div className="text-lg font-bold text-green-400">99.6%</div>
                  </div>
                  <div>
                    <div className="text-xs text-[#A0A0A0] mb-1">Latency (P95)</div>
                    <div className="text-lg font-bold text-cyan-400">42ms</div>
                  </div>
                  <div>
                    <div className="text-xs text-[#A0A0A0] mb-1">False Positive Rate</div>
                    <div className="text-lg font-bold text-yellow-400">0.3%</div>
                  </div>
                  <div>
                    <div className="text-xs text-[#A0A0A0] mb-1">Throughput</div>
                    <div className="text-lg font-bold text-orange-400">2.4K/s</div>
                  </div>
                </div>
              </div>
            </div>
                ...
                {[
                  ...
                  <div key={layer.num} className="bg-white/5 backdrop-blur-lg rounded-lg p-4 border border-green-500/30">
                    ...
                    <div className="flex items-center justify-between text-xs">
                      <span className="text-[#A0A0A0]">Uptime</span>
                      <span className="text-[#F5F5F5]">{layer.uptime}</span>
                    </div>
                    <div className="flex items-center justify-between text-xs mt-1">
                      <span className="text-[#A0A0A0]">Avg Latency</span>
                      <span className="text-[#F5F5F5]">{layer.latency}</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-white/5 backdrop-blur-lg rounded-lg p-4 border border-white/10">
                  <div className="text-xs text-[#A0A0A0] mb-1">Avg Response Time</div>
                  <div className="text-2xl font-bold text-green-400">2.8s</div>
                  <div className="text-xs text-zinc-500 mt-1">Target: &lt;5min ✓</div>
                </div>
                <div className="bg-white/5 backdrop-blur-lg rounded-lg p-4 border border-white/10">
                  <div className="text-xs text-[#A0A0A0] mb-1">Detection Rate</div>
                  <div className="text-2xl font-bold text-cyan-400">99.6%</div>
                  <div className="text-xs text-zinc-500 mt-1">847 threats blocked</div>
                </div>
                <div className="bg-white/5 backdrop-blur-lg rounded-lg p-4 border border-white/10">
                  <div className="text-xs text-[#A0A0A0] mb-1">False Negatives</div>
                  <div className="text-2xl font-bold text-yellow-400">0.1%</div>
                  <div className="text-xs text-zinc-500 mt-1">2 incidents (24h)</div>
                </div>
                <div className="bg-white/5 backdrop-blur-lg rounded-lg p-4 border border-white/10">
                  <div className="text-xs text-[#A0A0A0] mb-1">System Load</div>
                  <div className="text-2xl font-bold text-orange-400">34%</div>
                  <div className="text-xs text-zinc-500 mt-1">Healthy capacity</div>
                </div>
              </div>
            </div>
          </div>
                ...
                <div key={index} className="flex items-center justify-between p-4 bg-white/5 rounded-lg border border-white/10 hover:bg-white/10 transition-colors">
                  <div className="flex items-center gap-4 flex-1">
                    ...
                    <div>
                      ...
                      <div className="text-[#A0A0A0] text-sm">{item.requests} requests</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-6">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-zinc-500 text-xs">Success</div>
                    </div>
                  </div>
                </div>
              ))}
              ...
              <div className="space-y-6">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-[#F5F5F5]">CPU Usage</span>
                    <span className="text-cyan-400 font-medium">34%</span>
                  </div>
                  <div className="w-full bg-[#1A1A1A] rounded-full h-2">
                    <div className="bg-gradient-to-r from-cyan-500 to-orange-500 h-2 rounded-full" style={{ width: '34%' }}></div>
                  </div>
                </div>

                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-[#F5F5F5]">Memory Usage</span>
                    <span className="text-red-400 font-medium">2.8 GB / 5 GB</span>
                  </div>
                  <div className="w-full bg-[#1A1A1A] rounded-full h-2">
                    <div className="bg-gradient-to-r from-red-500 to-pink-500 h-2 rounded-full" style={{ width: '56%' }}></div>
                  </div>
                </div>

                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-[#F5F5F5]">Network I/O</span>
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-xl p-6 border border-white/10">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                  <span className="text-[#F5F5F5]">Connection Pool</span>
                  <span className="text-green-400 font-medium">Healthy</span>
                </div>
                <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                  <span className="text-[#F5F5F5]">Query Latency</span>
                  <span className="text-cyan-400 font-medium">12ms avg</span>
                </div>
                <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                  <span className="text-[#F5F5F5]">Cache Hit Rate</span>
                  <span className="text-red-400 font-medium">94.2%</span>
                </div>
                <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                  <span className="text-[#F5F5F5]">Active Connections</span>
                  <span className="text-orange-400 font-medium">47 / 100</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-lg rounded-xl p-6 border border-white/10 mt-8">
            ...
            <div className="flex items-center justify-between mt-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[#A0A0A0] text-sm">Operational</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 bg-red-500 rounded"></div>
                <span className="text-[#A0A0A0] text-sm">Downtime</span>
              </div>
